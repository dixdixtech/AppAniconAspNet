...
-- selects para produto favor tirar depois --
select Prod_Nome,categ.Categ_Nome, Prod_Garant, Prod_Val, Prod_QuantEstoq, Prod_Descri, Prod_Img from Produto prod inner join Categoria categ on prod.Categ_Id = categ.Categ_Id;
